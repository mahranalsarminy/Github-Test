...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        try {
            $stmt = $pdo->prepare("
                INSERT INTO privacy_content (title, content, sort_order, is_active) 
                VALUES (?, ?, ?, ?)
            ");
            
            $stmt->execute([$title, $content, $sort_order, $is_active]);
            $success_message = "Privacy section added successfully!";
            ...
            $error_message = "Error adding privacy section. Please try again.";
        }
    }
}
?>
...
<head>
    ...
    <title>Add Privacy Section - Admin Panel</title>
    ...
    <div class="main-container ml-64 p-4">
        <main class="container mx-auto mt-8">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-semibold">Add New Privacy Section</h1>
