...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['delete_section'])) {
        ...
        $stmt = $pdo->prepare("DELETE FROM terms_content WHERE id = ?");
        ...
        $stmt = $pdo->prepare("UPDATE terms_content SET is_active = ? WHERE id = ?");
...
// Fetch all sections
$stmt = $pdo->query("SELECT * FROM terms_content ORDER BY sort_order ASC");
...
<head>
    ...
    <title>Manage Terms - Admin Panel</title>
    ...
    <div class="main-container ml-64 p-4">
        <main class="container mx-auto mt-8">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold">Manage Terms and Conditions</h1>
                <a href="/admin/add_terms.php" class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition duration-200">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-4 px-6 text-center">
                                    <div class="flex justify-center space-x-2">
                                        <a href="/admin/edit_terms.php?id=<?php echo $section['id']; ?>" 
