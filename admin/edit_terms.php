...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        try {
            ...
            $stmt = $pdo->prepare("SELECT * FROM terms_content WHERE id = ?");
...
<head>
    ...
    <title>Edit Terms Section - Admin Panel</title>
    ...
    <div class="main-container ml-64 p-4">
        <main class="container mx-auto mt-8">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-3xl font-bold">Edit Terms Section</h1>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <form method="POST" class="space-y-6">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="/admin/terms.php" class="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-600 transition duration-200">
